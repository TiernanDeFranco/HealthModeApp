...
public partial class NewArmsEntry : ContentPage
{
    ...
    public NewArmsEntry(ISQLiteDataService localData, DateTime date, WeightTable weightEntry)
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        {
            var number = await _localData.GetArms(userID, _date);
        ...
        {
            var number = Math.Round(_weightEntry.Arms, 2);
    ...
    async void ToolbarItem_Clicked(System.Object sender, System.EventArgs e)
    {
        ...
        if (!entryExists)
        {
            await _localData.AddArmsEntry(userID, DateSelect.Date, INCHMValue);
        }
        else
        {
            await _localData.UpdateArmsEntry(userID, DateSelect.Date, INCHMValue);
        }
