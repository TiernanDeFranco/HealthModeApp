...
namespace HealthModeApp.Models
{
    public class NutritionModel : INotifyPropertyChanged
    {
        ...
        string _servingunit;
        public string ServingUnit { get => _servingunit; set { if (_servingunit == value) return; _servingunit = value; PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(ServingUnit))); } }

        decimal? _grams;
        public decimal? Grams { get => _grams; set { if (_grams == value) return; _grams = value; PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(Grams))); } }
        ...
        int? _mealtype;
        public int? MealType { get => _mealtype; set { if (_mealtype == value) return; _mealtype = value; PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(MealType))); } }

        string _category;
        public string Category { get => _category; set { if (_category == value) return; _category = value; PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(Category))); } }
